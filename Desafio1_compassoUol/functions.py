#Esse programa utiliza a API https://swapi.dev e mongodb para realizar consultas e salvar as informações em uma listagem de favoritos.
...
def choices():
    ...
    user = str(input('\033[1;33mBem vindo, seja você! Qual seu nome?:\n')).capitalize()
    while True:
            ...
            if opt == (len(opcoes) - 1):
                ...
                if unique_favorite == 'S':
                    ...
                    for x in mycol.find():
                        print(x)
                    print('')
            #acessa as possibilidades de escolha de ids na API
            elif opt != len(opcoes):
                # input dos ids
